...
public class WifiInfo {
    ...
    private double aver_dist;

    public WifiInfo(WifiInfo wifiInfo){
        new WifiInfo(wifiInfo.getSsid(), wifiInfo.getBssid(), wifiInfo.getPx(), wifiInfo.getPy());
    }


    public WifiInfo(String ssid, String bssid, double px, double py){
        this.ssid = ssid;
        this.bssid = bssid;
        this.px = px;
        this.py = py;
    ...
    public double getAver_dist() {
        return aver_dist;
    }

    public void setAver_dist(double aver_dist) {
        this.aver_dist = aver_dist;
    }
}
